...
function ParserSelector(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("h1", { children: " Choose your Natural Language Parser " }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(ParserDescriptions_1.default, {}), (0, jsx_runtime_1.jsxs)(FormControl_1.default, { children: [(0, jsx_runtime_1.jsx)(FormLabel_1.default, __assign({ id: "parsers-radio-buttons-group-label" }, { children: "Parsers" })), (0, jsx_runtime_1.jsxs)(RadioGroup_1.default, __assign({ row: true, "aria-labelledby": "parsers-radio-buttons-group-label", defaultValue: Parser_1.defaultParser.name, name: "parserName", 
                                /* value={defaultParser.name} */
                                value: parserName, onChange: handleParserChange }, { children: [(0, jsx_runtime_1.jsx)(FormControlLabel_1.default, { value: "parts-of-speech", control: (0, jsx_runtime_1.jsx)(Radio_1.default, {}), label: "Parts-of-Speech" }), (0, jsx_runtime_1.jsx)(FormControlLabel_1.default, { value: "en-pos", control: (0, jsx_runtime_1.jsx)(Radio_1.default, {}), label: "en-pos" })] }))] })] })] }));
}
