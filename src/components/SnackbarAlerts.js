...
function SnackbarAlerts(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Snackbar_1.default, __assign({ open: open, autoHideDuration: 6000, onClose: handleSnackClose, anchorOrigin: { vertical: 'top', horizontal: 'center' } }, { children: (0, jsx_runtime_1.jsx)(Alert, __assign({ onClose: handleSnackClose, severity: severity, sx: { width: '100%' } }, { children: message })) })));
}
