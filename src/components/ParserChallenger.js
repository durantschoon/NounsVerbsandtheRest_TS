...
function ParserChallenger(_a) {
    var author = _a.author, authorUpdater = _a.authorUpdater, authorApplyWordFunc = _a.authorApplyWordFunc, parser = _a.parser;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ParserSelector_1.default, __assign({}, { authorUpdater: authorUpdater, parserName: author.currentParser.name })), (0, jsx_runtime_1.jsx)("h1", { children: " Correct what is and is not a noun " }), (0, jsx_runtime_1.jsxs)("ul", { children: [(0, jsx_runtime_1.jsxs)("li", { children: ["Click on a word with the ", (0, jsx_runtime_1.jsx)("span", __assign({ className: "non-noun" }, { children: "Plus" })), " ", (0, jsx_runtime_1.jsx)("img", { id: "non-noun-cursor-img" }), " cursor to change a word INTO a noun."] }), (0, jsx_runtime_1.jsxs)("li", { children: ["Click on a word with the ", (0, jsx_runtime_1.jsx)("span", __assign({ className: "noun" }, { children: "Back" })), " ", (0, jsx_runtime_1.jsx)("img", { id: "noun-cursor-img" }), " cursor to change a word BACK TO a non-noun."] })] }), (0, jsx_runtime_1.jsx)("div", { id: "text-output" }), (0, jsx_runtime_1.jsx)(WordStats_1.default, __assign({}, {
