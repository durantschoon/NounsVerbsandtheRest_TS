...
function selector(selName, value, setter, valList) {
    var menuKey = 0;
    return ((0, jsx_runtime_1.jsxs)(FormControl_1.default, __assign({ margin: "dense" }, { children: [(0, jsx_runtime_1.jsx)(InputLabel_1.default, __assign({ id: "".concat(selName, "-select-label") }, { children: capitalizeFirstLetter(selName) })), (0, jsx_runtime_1.jsx)(Select_1.default, __assign({ labelId: "".concat(selName, "-select-label"), id: "".concat(selName, "-select"), value: value, label: capitalizeFirstLetter(selName), onChange: function (event) { return setter(event.target.value); } }, { children: valList.map(function (s) { return ((0, jsx_runtime_1.jsx)(MenuItem_1.default, __assign({ value: s }, { children: s }), menuKey++)); }) }))] })));
}
function PoemSelector(_a) {
    var _b;
    var author = _a.author, authorUpdater = _a.authorUpdater, loadingProgress = _a.loadingProgress;
    ...
    var joinedLines = author.currentPoem.lines
        ...
        : "";
    var aD = author;
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("h1", { children: " Select a poem " }), aD && aD.name && aD.authorNames && authorSelector(), aD && ((_b = aD.currentPoem) === null || _b === void 0 ? void 0 : _b.title) && aD.titles && titleSelector(), loadingProgress.percentage > 0 && loadingProgress.percentage < 100 && ((0, jsx_runtime_1.jsx)(AuthorProgress_1.default, __assign({}, loadingProgress))), (0, jsx_runtime_1.jsx)("textarea", { value: joinedLines, id: "text-input", readOnly: true })] }));
}
