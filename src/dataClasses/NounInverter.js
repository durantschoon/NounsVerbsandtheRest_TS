...
var NounInverter = /** @class */ (function () {
    function NounInverter(author) {
        ...
        Object.defineProperty(this, "falseNegativeCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        value: function () {
            ...
            */
            lines.forEach(function (line, index) {
                ...
                var matchedSpacePunct = ((_a = line
                    .match(spacePunct)) === null || _a === void 0 ? void 0 : _a.map(function (s) { return s.replace(/ /g, UNICODE_NBSP); })) || [];
