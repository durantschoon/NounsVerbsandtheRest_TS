...
exports.defaultTitlesByAuthor =
  exports.defaultAuthorNames =
  exports.defaultPoemLines =
  exports.defaultTitles =
  exports.defaultTitle =
  exports.defaultAuthorName =
    void 0;
var sonnets = {
  "William Shakespeare": {
    "Sonnet 60":
...
for (var _i = 0, _a = Object.entries(sonnets); _i < _a.length; _i++) {
  var _b = _a[_i],
    sAuthor = _b[0],
    sonnetsByAuthor = _b[1];
  firstAuthorName =
    firstAuthorName !== null && firstAuthorName !== void 0
      ? firstAuthorName
      : sAuthor;
  ...
  for (var _c = 0, _d = Object.entries(sonnetsByAuthor); _c < _d.length; _c++) {
    var _e = _d[_c],
      ...
      lines = _e[1];
    firstTitle =
      firstTitle !== null && firstTitle !== void 0 ? firstTitle : sTitle;
    titlesByAuthor[sAuthor].push(sTitle);
    firstPoemLines =
      firstPoemLines !== null && firstPoemLines !== void 0
        ? firstPoemLines
        : lines;
  }
  firstTitles =
    firstTitles !== null && firstTitles !== void 0
      ? firstTitles
      : titlesByAuthor[firstAuthorName];
}
exports.defaultAuthorName = firstAuthorName;
exports.defaultTitle = firstTitle;
exports.defaultTitles = firstTitles;
exports.defaultPoemLines = firstPoemLines;
