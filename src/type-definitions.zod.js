...
exports.poemData = zod_1.z.object({
    title: exports.title,
    lines: zod_1.z.array(exports.line),
});
exports.poem = zod_1.z.instanceof(Poem_1.default);
exports.poemsByAuthor = zod_1.z.record(exports.authorName, zod_1.z.array(exports.poemData));
exports.titlesByAuthor = zod_1.z.record(exports.authorName, zod_1.z.array(exports.title));
exports.falsePositiveCount = zod_1.z.number().refine(function (val) { return val >= 0; }, function (val) { return ({
    message: "False Positive ".concat(val, " must be greater than or equal to 0"),
}); });
exports.falseNegativeCount = zod_1.z.number().refine(function (val) { return val >= 0; }, function (val) { return ({
    message: "False Negative ".concat(val, " must be greater than or equal to 0"),
}); });
...
exports.nounInverter = zod_1.z.object({
    ...
    falseNegativeCount: exports.falseNegativeCount,
...
exports.tags = zod_1.z.array(zod_1.z.tuple([zod_1.z.string(), zod_1.z.string()]));
exports.parserMap = zod_1.z.record(zod_1.z.string(), zod_1.z.instanceof(Parser_1.Parser));
// Loading
var percentage = zod_1.z.number().refine(function (val) { return val >= 0 && val <= 100; });
exports.url = zod_1.z.string().url();
exports.poetryURL = exports.url;
exports.toast = zod_1.z.object({
